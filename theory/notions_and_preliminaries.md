...
## Произведения по Третьему Измерению

### Произведение по Моде-3 на Матрицу
...
- **Определение**:
  ...
  $$
  (\mathbf{B} \times_3 \mathcal{X})_{i_1 i_2 :} = \mathbf{B} \times \mathcal{X}_{i_1 i_2 :}, \quad \forall i_1, i_2
  $$
...
### Произведение по Моде-3 на Вектор
...
- **Определение**:
  ...
  $$
  \mathcal{X} \times_{(3)} \mathbf{v} = \sum_{k=1}^{K} \mathcal{X}_{::k} \cdot v_k
  $$
...
## Транспонирование Тензора по Фронтальным Срезам

- **Определение**:

  $$
  (\mathcal{X}^\top)_{::k} = \mathcal{X}_{::(K + 1 - k)}
  $$
...
## Точечное Произведение Тензоров по Трубкам

- **Определение**:

  $$
  (\mathcal{X}^\top \times_{\text{dot}} \mathcal{X})_{ij} = \sum_{k=1}^{K} ( \mathcal{X}_{::i} \cdot \mathcal{X}_{::j} )_k
  $$
